...
- I am a Master's student at Koç University, working in <a rel="noopener noreferrer"  target="_blank" href="https://parcorelab.ku.edu.tr/" class="text-decoration-none text-reset"><kbd style={{color:"#FFFFFF", backgroundColor:"#C00A27"}}>ParCoreLab</kbd></a>. My main research topic is optimization of GPU communication in 3D stencil applications.
